...
This plugin is available in the [Gradle Plugin Portal](https://plugins.gradle.org/plugin/org.stoyicker.android-check) (see [#24](https://github.com/stoyicker/android-check-2)) and in jCenter. It attaches itself to the `check` task.
